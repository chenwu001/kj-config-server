...
public class SwaggerAutoConfiguration {
    ...
    public Docket defaultDocket() {
        ApiInfo apiInfo = new ApiInfoBuilder().title("客佳配置中心")
                .description("客佳配置中心").version("1.0.0")
                .license("客佳").licenseUrl("http://www.dada365.com")
                .contact(new Contact("客佳", "http://www.dada365.com",
                        "service@kjdow.com"))
                .termsOfServiceUrl("http://http://www.dada365.com").build();
